...
Reference full template: `/home/ivan/repos/tunnel/.cursor/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/ivan/repos/tunnel/.cursor/get-shit-done/templates/state.md`.
