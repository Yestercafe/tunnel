...
Use template from `/home/ivan/repos/tunnel/.cursor/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/ivan/repos/tunnel/.cursor/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/ivan/repos/tunnel/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
