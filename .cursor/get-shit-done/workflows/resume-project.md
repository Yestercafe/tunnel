...
<required_reading>
@/home/ivan/repos/tunnel/.cursor/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/ivan/repos/tunnel/.cursor/get-shit-done/bin/gsd-tools.cjs" init resume)
